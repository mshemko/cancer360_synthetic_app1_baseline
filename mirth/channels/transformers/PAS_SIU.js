...
try {
    ...
    executeUpdate(conn, $('sql.appointment.upsert'), [
        ...
        parseIsoDate(startDt), null, 'PAS', String(schedule['SCH.7']['SCH.7.1']),
        String(schedule['SCH.6']['SCH.6.1']), String(schedule['SCH.12']['SCH.12.1']).toLowerCase(),
        null, String(schedule['SCH.16']['SCH.16.1']), String(schedule['SCH.7']['SCH.7.1']),
        'PAS', String(msg['MSH']['MSH.10']['MSH.10.1'])
    ]);
